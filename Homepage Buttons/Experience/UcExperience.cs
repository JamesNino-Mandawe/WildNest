...
namespace Project
{
    public partial class UcExperience : UserControl
    {
        ...
        private void BuildUI()
        {
            ...
            lblHeroTitle.Font = new Font("Georgia", 32f, FontStyle.Bold);
            lblHeroTitle.ForeColor = C_CREAM;
            lblHeroTitle.BackColor = Color.Transparent;
            lblHeroTitle.Text = "Wildlife Experiences";
            ...
            Action layoutHero = () =>
            {
                ...
                lblHeroTitle.Location = new Point(cx - lblHeroTitle.PreferredWidth / 2, 160);
        ...
        private void DoGridLayout(string filter)
        {
            ...
            pnlMain.Height = contentH + 20;
            pnlSideIcons.Height = pnlMain.Height;
            int totalHeight = Math.Max(pnlSideIcons.Bottom, pnlMain.Bottom);
            this.Height = pnlStatusBar.Bottom + totalHeight + 24;
        ...
        private void PaintFilterBtn(PaintEventArgs e, Button btn, string emoji, string label, bool active)
        {
            ...
            TextRenderer.DrawText(g, emoji,
                ...
                active ? C_GOLD : Color.FromArgb(150, C_CREAM),
            ...
            TextRenderer.DrawText(g, label,
                ...
                active ? C_GOLD : Color.FromArgb(100, C_CREAM),
                TextFormatFlags.HorizontalCenter);
        }
        ...
        private void PaintSignature(object sender, PaintEventArgs e)
        {
            ...
            TextRenderer.DrawText(g, _signature.Price,
                new Font("Georgia", 16f, FontStyle.Bold),
                new Rectangle(rx, iy, 140, 30),
                C_GOLD_LIGHT,
                TextFormatFlags.Left | TextFormatFlags.VerticalCenter);
            TextRenderer.DrawText(g, "/person",
                new Font("Segoe UI", 7.5f),
                new Rectangle(rx, iy + 20, 70, 14),
                Color.FromArgb(90, C_CREAM),
                TextFormatFlags.Left);
        ...
        private void ShowDetail(ExpInfo exp)
        {
            ...
            Control overlayParent = parentForm ?? (Control)this;

            int mw = Math.Min(700, overlayParent.Width - 60);
            int mh = Math.Min(620, overlayParent.Height - 60);
            ...
            // ── HERO SECTION
            int heroH = 160;
            var hero = new Panel { Location = Point.Empty, Size = new Size(mw, heroH) };
            hero.Paint += (s, pe) =>
            {
                var g = pe.Graphics;
                g.SmoothingMode = SmoothingMode.AntiAlias;
            ...
            {
                pe.Graphics.SmoothingMode = SmoothingMode.AntiAlias;
                // gold divider line at top of strip
                ...
                TextRenderer.DrawText(pe.Graphics, exp.Price,
                    ...
                    new Rectangle(24, 8, 160, 36),
                    C_GOLD_LIGHT,
                    TextFormatFlags.Left | TextFormatFlags.VerticalCenter);

                TextRenderer.DrawText(pe.Graphics, "/person  ·  " + exp.Cancel,
                    new Font("Segoe UI", 8f),
                    new Rectangle(24, 46, 340, 18),
                    Color.FromArgb(100, C_CREAM),
                    TextFormatFlags.Left);
            };
            ...
            btnBook.Location = new Point(mw - 158, 16);
            strip.Resize += (s, e) => btnBook.Location = new Point(strip.Width - 158, 16);
            ...
            int by = 0;
            int bodyW = mw - 56; // 28px padding each side
            ...
            {
                SizeF sz = g2.MeasureString(exp.Desc, descLabel.Font, bodyW);
            ...
            for (int ai = 0; ai < exp.Includes.Length; ai++)
            {
                ...
                chip.Paint += (s, pe) =>
                {
                    ...
                    {
                        using (var br = new SolidBrush(Color.FromArgb(16, 40, 22)))
                ...
                chip.Controls.Add(new Label
                {
                    Text = iname,
                    Font = new Font("Segoe UI", 7.5f),
                    ForeColor = Color.FromArgb(160, C_CREAM),
                    AutoSize = false,
                    Size = new Size(aChipW - 6, 24),
                    BackColor = Color.Transparent,
        ...
        private void PaintHeroBackground(object sender, PaintEventArgs pe)
        {
            ...
            using (var br = new SolidBrush(Color.FromArgb(10, 36, 18)))
