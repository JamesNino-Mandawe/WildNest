...
namespace Project.Booking
{
    public partial class CabinStay : UserControl
    {
        ...
        private void BuildUi()
        {
            ...
            if (_uiBuilt)
                ResetGeneratedLayout(new[] { pnlCabin, pnlGuestInfo, pnlPayment, pnlConfirm });
        ...
        private void BuildCabinStep()
        {
            ...
            sAddon.Height = 72 + aBody.Height + 32;
        ...
        private void BuildGuestStep()
        {
            ...
            int fw = (W - GAP) / 2;
            int fh = 38;
            int rH = 82;   // label(20) + field(38) + breathing room
            ...
            int chkRowY = reqY + 20 + 76 + 18;
            var chkRow = new Panel { Location = new Point(0, chkRowY), Size = new Size(bW, 56), BackColor = Color.Transparent };
            chkRow.Paint += (s, e) =>
            {
                e.Graphics.SmoothingMode = SmoothingMode.AntiAlias;
            ...
            int verifyY = chkRowY + 70;
            int verifyH = AddEmailVerificationBlock(body, verifyY, bW);
        ...
        private void ConfirmBooking()
        {
            ...
            VALUES
                ...
                resCmd.Parameters.AddWithValue("@arrTime", _cboArrival?.Text ?? "");
                resCmd.Parameters.AddWithValue("@transport", _cboTransport?.Text ?? "");
                resCmd.ExecuteNonQuery();

                foreach (var addon in _addons)
                {
                    int? experienceId = BookingPersistence.ResolveExperienceId(conn, tx, addon.Key);
                ...
                _ = System.Threading.Tasks.Task.Run(() =>
                {
                    ...
                    if (!result.Success)
                        ProjectDiagnostics.LogWarning("CabinStay", $"Booking {bid} was saved but confirmation email failed: {result.Message}");
                });
