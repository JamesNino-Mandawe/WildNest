...
{
    public partial class CabinStay
    {
        ...
        private int AddEmailVerificationBlock(Panel body, int y, int width)
        {
            ...
            panel.Controls.Add(new Label
            {
                ...
                ForeColor = BookingFlowTheme.TextDim,
                AutoSize = true,
            ...
            panel.Controls.Add(new Label
            {
                Text = "We’ll send a 6-digit code to confirm that you own this email before booking.",
                Font = new Font("Segoe UI", 8f),
                ForeColor = BookingFlowTheme.TextMuted,
                AutoSize = true,
            ...
            _txtEmailVerificationCode = new TextBox
            {
                Location = new Point(158, 52),
            ...
            _lblEmailVerification = new Label
            {
                Text = "Verification required before you can continue.",
                Font = new Font("Segoe UI", 8f),
                ForeColor = BookingFlowTheme.TextMuted,
                AutoSize = false,
                Size = new Size(width - 28, 42),
        ...
        private void ResetEmailVerificationState(bool clearStatus = true)
        {
            ...
            if (_txtEmailVerificationCode != null)
                _txtEmailVerificationCode.Clear();
            if (_btnSendEmailCode != null)
            {
                _btnSendEmailCode.Enabled = true;
                _btnSendEmailCode.Text = "Send Code";
            }
            if (_btnVerifyEmailCode != null)
                _btnVerifyEmailCode.Enabled = false;
