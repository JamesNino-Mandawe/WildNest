...
namespace Project.Booking
{
    internal static class BookingFlowTheme
    {
        ...
        internal static readonly Color Shadow = Color.FromArgb(22, 0, 0, 0);
        ...
        internal static Panel CreateSection(string icon, string title, string subtitle, int width)
        {
            ...
            section.Paint += (s, e) =>
            {
                ...
                using var shadowPath = RoundedRect(new Rectangle(3, 5, section.Width - 7, section.Height - 9), 12);
        ...
        internal static Panel GetBody(Panel section) =>
            section.Tag as Panel ?? throw new InvalidOperationException("Section body panel is missing.");
        ...
        internal static void PaintSectionShell(Graphics g, Rectangle bounds)
        {
            ...
            using var divider = new Pen(Color.FromArgb(24, 0, 0, 0), 1f);
