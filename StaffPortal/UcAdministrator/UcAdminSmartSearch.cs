...
{
    internal sealed class UcAdminSmartSearch : Panel
    {
        private readonly TextBox _txtSearch;
        private readonly FlowLayoutPanel _results;
        private readonly Label _summary;

        public UcAdminSmartSearch()
        {
            Height = 360;
            ...
            header.Controls.Add(new Label
            {
                Text = "Find bookings, guests, cabins, animals, experiences, payments, tours, care logs, users, and chats from one place.",
            ...
            {
                PlaceholderText = "Search booking ID, guest, email, cabin, animal, experience, status, role, payment, tour...",
        ...
        private void RenderEmptyState()
        {
            ...
            _summary.Text = "Try: WN-2026, guest email, cabin, animal, experience, health status, payment status, or staff role.";
            AddHint("Search covers reservations, guests, cabins, experiences, animals, health records, feeding records, tours, users, payments, guest chat, and staff chat.");
        }
